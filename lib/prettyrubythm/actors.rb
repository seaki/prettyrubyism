module PrettyRubythm
  ...
  class Actor < Hash # rubocop:disable Metrics/ClassLength
    ...
    class << self
      ...
      def find(actor_name)
        ...
        unless @cache[actor_name]
          ...
          @cache[actor_name] = PrettyRubythm::Actor[actor_config].tap {|actor| actor.io = $stdout }
        end
